...
void plt_register_flying_camera_component(Plt_World *world) {
	plt_world_register_component(world, PLT_COMPONENT_FLYING_CAMERA_CONTROLLER, sizeof(Plt_Object_Type_Flying_Camera_Controller_Data), _flying_camera_controller_type_init, _flying_camera_controller_type_update, NULL);
}

...
void _mesh_renderer_type_render_scene(Plt_World *world, Plt_Entity_ID entity_id, void *instance_data, Plt_Frame_State state, Plt_Renderer *renderer) {
...
void plt_register_mesh_renderer_component(Plt_World *world) {
	plt_world_register_component(world, PLT_COMPONENT_MESH_RENDERER, sizeof(Plt_Object_Type_Mesh_Renderer_Data), NULL, NULL, _mesh_renderer_type_render_scene, NULL);
}

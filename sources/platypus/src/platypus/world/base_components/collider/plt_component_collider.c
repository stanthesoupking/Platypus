...
void _collider_type_render_scene(Plt_World *world, Plt_Entity_ID entity_id, void *instance_data, Plt_Frame_State state, Plt_Renderer *renderer) {
...
#if PLT_DEBUG_COLLIDERS
	render_scene = _collider_type_render_scene;
#endif
	
	plt_world_register_component(world, PLT_COMPONENT_COLLIDER, sizeof(Plt_Object_Type_Collider_Data), NULL, NULL, render_scene, NULL);
}
